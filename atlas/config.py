...
from atlas.config_local import (ENVIRONMENT, SSL_KEY_FILE, SSL_CRT_FILE, ALLOWED_USERS,
                                ...
                                LDAP_DNS_DOMAIN_NAME, SSH_USER, WEBSERVER_USER, WEBSERVER_USER_GROUP,
                                DATABASE_USER, DATABASE_PASSWORD, SERVICE_ACCOUNT_USERNAME,
                                ...
                                EMAIL_PASSWORD, LOG_LOCATION, EMAIL_USERS_EXCLUDE, STATIC_WEB_PATH,
                                BACKUP_PATH, BACKUP_IMPORT_PATH, SMTP_PASSWORD, SAML_AUTH)
